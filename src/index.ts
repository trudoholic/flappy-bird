...
const PIXI_loader = new PIXI.Loader;
// PIXI.loader is deprecated, Use app.loader or let loader = new PIXI.Loader
...
class Bird {
  ...
  private updateTexture = () => {
    ...
    this.sprite.texture = PIXI_loader.resources[BIRD_FRAME_LIST[this.textureCounter++]].texture;
